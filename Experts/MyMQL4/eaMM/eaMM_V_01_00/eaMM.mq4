...
void OnTick()
  {
//---
// commentaire ajout� par contributeur
   MqlTick last_tick;
...
void OpenBuy(const double &NumberOfLotsToOpen,const double &StopLoss)
  {
   ...
   if(ticketOrder<0)
     {
      Log(ERROR,__FILE__,__FUNCTION__,__LINE__,StringConcatenate("Probl�me ouverture Ordre : ",ErrorDescription(GetLastError()),"  NumberOfLotsToOpen :",NumberOfLotsToOpen));
     }
  }
//+------------------------------------------------------------------+
